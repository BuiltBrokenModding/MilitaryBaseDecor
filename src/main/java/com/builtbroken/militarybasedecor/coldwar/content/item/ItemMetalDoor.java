package com.builtbroken.militarybasedecor.coldwar.content.item;
...
public class ItemMetalDoor extends Item
{
    private Material doorMaterial;

    public ItemMetalDoor(Material material)
    {
        this.doorMaterial = material;
        this.maxStackSize = 1;
        this.setUnlocalizedName(MilitaryBaseDecor.DOMAIN + ":" + "metal_door");
