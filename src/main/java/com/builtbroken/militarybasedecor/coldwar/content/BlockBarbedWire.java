...
public class BlockBarbedWire extends Block {
	    ...
	    public BlockBarbedWire(String p_i45432_1_, String p_i45432_2_, Material p_i45432_3_, boolean p_i45432_4_)
	    {
	        super(p_i45432_3_);
	    ...
	    {
	        return this.blockMaterial == Material.iron ? 41 : 18;
	    }
