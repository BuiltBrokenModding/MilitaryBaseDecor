...
//TODO Allow VE to properly load metal fence and BlockBarbedWire!
    public BlockMetalFence(String p_i45406_1_, Material p_i45406_2_)
    {
        super(p_i45406_1_, p_i45406_2_);
        this.setBlockName("metalFence");
        this.setBlockTextureName(MilitaryBaseDecor.PREFIX + "metalFence");
        this.setHardness(4F);
    ...
    public boolean canConnectFenceTo(IBlockAccess p_149826_1_, int p_149826_2_, int p_149826_3_, int p_149826_4_)
    {
        ...
        return block != this && block != Blocks.fence_gate ? (this.isOpaqueCube() && block.renderAsNormalBlock() ? this.blockMaterial != Material.gourd : false) : true;
    }
