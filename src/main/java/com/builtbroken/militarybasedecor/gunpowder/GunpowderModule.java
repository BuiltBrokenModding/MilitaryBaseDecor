...
public class GunpowderModule implements ILoadable
{
    ...
    public void postInit()
    {
    	...
    	// Rope Fence
    	GameRegistry.addShapedRecipe(new ItemStack(ropeFence, 1, 0), new Object[]{"PRP", "PRP", "PRP", 'P', Blocks.planks, 'R', rope});
    	// Items
    	// Rope
    	GameRegistry.addShapedRecipe(new ItemStack(rope, 3, 0), new Object[]{"   ", "SSS", "   ", 'S', Items.string});
    	// Tangled Rope
    	GameRegistry.addShapelessRecipe(new ItemStack(tangledRope, 4, 0), new Object[]{rope});
