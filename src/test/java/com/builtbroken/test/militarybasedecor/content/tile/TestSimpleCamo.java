...
public class TestSimpleCamo extends AbstractTileTest<TileSimpleCamo> {
    ...
    TileSimpleCamo tileCamo = new TileSimpleCamo("testSimpleCamo", Material.rock);

    public TestSimpleCamo() throws IllegalAccessException, InstantiationException
    {
        super("testSimpleCamo", TileSimpleCamo.class);
    }
